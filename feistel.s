...
extrn TableLength, counter_ec, CiphertextArray
global feistel_modify_table
...
feistel_modify_table:    
    movff	TableLength, counter_ec, A
    goto	feistel_encode_loop

feistel_encode_loop:
    tblrd*+			; one byte from PM to TABLAT, increment TBLPRT
    movff	TABLAT, POSTINC0; move data from TABLAT to (FSR0), inc FSR0	
    decfsz	counter_ec, A		; count down to zero
    bra		feistel_encode_loop		; keep going until finished
