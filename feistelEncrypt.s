...
psect feistel_code_encrypt, class=CODE
feistel_encrypt:    
    bra     feistel_loop_L2_R1       ; change for diffrent number of lengths and rounds
...
len10_k5:
    ...
    movf    char_10, W, A
    xorwf   key_5, W, A         ; F(R, Key) = R xor Key
    xorwf   char_4, W, A      ; New Right = L xor F(R, Key)
    movwf   char_4, A
    
    movf    char_6, W, A     ; Move Old R to be the new Left
    movwf   POSTINC2, A
    movf    char_7, W, A
    movwf   POSTINC2, A
    movf    char_8, W, A
